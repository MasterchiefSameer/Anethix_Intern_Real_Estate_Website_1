...
const UpdateListing = () => {
  ...
  // Fetch listing details on mount to populate inputs
  useEffect(() => {
    const fetchlisting = async () => {
      try {
        const listingId = params.listingId;
            // console.log('the listing is ', listingId);
      ...
      <div className='relative z-10 max-w-5xl mx-auto'>
        ...
        <div className='bg-white/95 backdrop-blur-md border border-white/20 shadow-xl rounded-2xl p-6 mb-8 text-left'>
          ...
          <p className='text-sm text-slate-500 mt-1'>
            Modify details and pictures for your active property listings below.
          </p>
        </div>
